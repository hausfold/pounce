...
- **⌘Tab window switcher** — opt-in MRU switcher across *windows*, fuzzy-filterable. With AeroSpace running it groups rows by workspace, and a tap-and-release skips whatever is tiled on screen beside you — so "back" means the window you can't see, not the one you're already looking at.
