...
// `nebelhaus.pounce.*` and this file isn't yours to edit — see the guard below.
...
enum ConfigMode {
    ...
    /// wrote it from `nebelhaus.pounce.*`. Writing there fails (the store is
