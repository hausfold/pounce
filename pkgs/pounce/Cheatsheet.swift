            ...
            HStack(spacing: pt(12)) {
                ...
                if searching {
                    ...
                    Text(state.placeholderText)
                        .font(uiFont(pt(20), weight: .semibold))
                        .foregroundColor(Theme.text)
                    if pages.count > 1 {
                        HStack(spacing: pt(4)) {
                            ForEach(pages, id: \.self) { p in
                                Text(p)
                                    .font(uiFont(pt(12), weight: .semibold))
    ...
    var emptyBody: some View {
        VStack(spacing: pt(10)) {
            ...
            Text("No cheatsheet at \((state.cheatsheetPath as NSString).abbreviatingWithTildeInPath)")
                .font(uiFont(pt(14), weight: .medium))
                .foregroundColor(Theme.subtext)
        ...
        VStack(alignment: .leading, spacing: pt(12)) {
            ...
            ForEach(group.items) { item in
                HStack(alignment: .top, spacing: pt(12)) {
                    Text(item.key)
                        .font(uiFont(pt(14), weight: .semibold, design: .monospaced))
                        .foregroundColor(Theme.text)
                    ...
                    Text(item.action)
                        .font(uiFont(pt(15), weight: .medium))
                        .foregroundColor(Theme.text)
                        .padding(.top, pt(3))
