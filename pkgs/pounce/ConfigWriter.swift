...
enum ConfigWriter {
    ...
    static func apply(
        ...
        guard let range = searchRange(lines, depths: depths, section: section) else {
            ...
            return insertSection(section, key: key, json: json, into: lines, depths: depths)
        }
    ...
    /// whole root object for a top-level key.
