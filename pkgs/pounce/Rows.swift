...
struct ItemRow: View {
    ...
    var body: some View {
        HStack(spacing: pt(14)) {
            ...
            Text(item.title)
                .foregroundColor(Theme.text)
                .font(uiFont(pt(16), weight: .medium, design: .rounded))
                .lineLimit(1)
            ...
            if let badge {
                Text(badge)
                    .font(uiFont(pt(12), weight: .semibold, design: .rounded))
                ...
                Text(subtitle)
                    .foregroundColor(Theme.subtext0)
                    .font(uiFont(pt(13), design: .rounded))
                    .lineLimit(1)
            }
        }
    ...
    var body: some View {
        HStack(spacing: pt(14)) {
            ...
            VStack(alignment: .leading, spacing: pt(3)) {
                Text(item.title)
                    .foregroundColor(Theme.text)
                    .font(uiFont(pt(25), weight: .semibold, design: .rounded))
                    .lineLimit(1)
    ...
    var body: some View {
        HStack(spacing: pt(6)) {
            Text(dial.name.uppercased())
                .font(uiFont(pt(10), weight: .semibold, design: .rounded))
                .kerning(0.5)
                .foregroundColor(Theme.subtext0)
            Text(dial.value)
                .font(uiFont(pt(12), weight: .semibold, design: .rounded))
...
struct CustomTextField: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSTextField {
        ...
        tf.font = uiNSFont(size: fontSize)
    ...
    func updateNSView(_ tf: NSTextField, context: Context) {
        ...
        let wantedFont = uiNSFont(size: fontSize)
